...
class Booking{
    ...
    sendBooking(){
        ...
        fetch(url, options)
          ...
          thisBooking.makeBooked(thisBooking.date, thisBooking.hourPicker.value, thisBooking.dom.duration.value, thisBooking.table);
          thisBooking.updateDOM();
    }

    choseTable(chosenTable){
        const thisBooking = this;
        ...
        if(!chosenTable.classList.contains(classNames.booking.tableBooked)){
            chosenTable.classList.add(classNames.booking.tableChosen);
            thisBooking.table = chosenTable.getAttribute('data-table');
        }
    }
